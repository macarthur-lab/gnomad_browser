...
# Mongo config
export MONGO_CONTROLLER_CONFIG={{ PROJECT_NAME }}-mongo-controller.yaml
...
export LOADING_POD_NAME={{ PROJECT_NAME }}-load
export LOADING_POD_CONFIG={{ PROJECT_NAME }}-load-pod.json
...
export SERVER_REPLICATION_CONTROLLER_NAME={{ PROJECT_NAME }}-serve
export SERVER_REPLICATION_CONTROLLER_CONFIG={{ PROJECT_NAME }}-serve-rc.yaml
...
export TABIX_POD_NAME={{ PROJECT_NAME }}-tabix-pod
export TABIX_POD_CONFIG={{ PROJECT_NAME }}-tabix-pod.yaml
